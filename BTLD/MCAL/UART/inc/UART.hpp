...
enum class UART_Mode : uint8 { RX = 0x04, TX = 0x08, TX_RX = 0x0C };
enum class UART_Parity : uint8 { NONE = 0, EVEN, ODD };
enum class UART_StopBits : uint8 { BITS_1 = 0x00, BITS_0_5 = 0x01, BITS_2 = 0x02, BITS_1_5 = 0x03 };
enum class UART_WordLength : uint8 { BITS_8 = 0, BITS_9 };
enum class UART_Synch : uint8 { Polling = 0, Interrupt = 32 };
enum class UART_HardWare : uint8 { UART1 = 0, UART2, UART3 };
...
/* C-compatible aliases for BTLD/Parse.cpp */
inline void UART_SendSyncBuffer(UART_HardWare hw, const uint8 *buf, uint8 size)
{
    UART::SendSyncBuffer(hw, buf, size);
}
inline void UART_voidSendNumber(UART_HardWare hw, sint32 num)
{
    UART::SendNumber(hw, num);
}
